        ...
        switch(item.getItemId()){
            ...
            case R.id.notif :
                Notification.Builder mBuilder = new Notification.Builder(MainActivity.this).setSmallIcon(R.drawable.smallicon).setContentTitle("Notif")
                        .setContentText("Ceci est une notification").setAutoCancel(true);
            ...
            case R.id.ne :
                ...
                return true;
            case R.id.FR :
                Intent intentFR = new Intent(MainActivity.this, SecondActivityFR.class);
                startActivity(intentFR);
                return true;
            case R.id.EN :
                Intent intentEN = new Intent(MainActivity.this, SecondActivityEN.class);
