...
public class BiersAdapterFR {

    private JSONArray biers;



    public BiersAdapterFR(JSONArray jsonArray){
        this.biers = jsonArray;
    }

    @Override
    public BiersAdapterFR.BierHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.rv_bier_element, null, false);
        return new BierHolder(v);
    }

    @Override
    public void onBindViewHolder(BiersAdapterFR.BierHolder holder, int position) {
        try {
